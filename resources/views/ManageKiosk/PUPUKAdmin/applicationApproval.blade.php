    ...
    <div class="container-fluid p-0">
        <div class="main-section">
            ...
            <div class="card h-100">
                <div class="card-body">
                    <h5 class="card-title fw-bold text-center">Application Approval</h5>
                    ...
                    <div class="row g-3" >
                        ...
                        <div class="col-8 mt-4">
                            <div class="form-outline" data-mdb-input-init>
                                <input type="number" class="form-control" id="age" min="0" step="1"
                                    name="age" required style="appearance: none; -moz-appearance: textfield;" value="{{ $kioskParticipant->kpAge }}" disabled />
                        ...
                        <div class="col-8 mt-4">
                            <div class="form-outline" data-mdb-input-init>
                                <input type="text" class="form-control" id="validationCustom02" name="kBusinessName"  value="{{ $kioskApplication->kBusinessName }}" disabled/>
                        ...
                        <div class="col-8 mt-4">
                            <div class=" form-outline" data-mdb-input-init>
                                ...
                                <input type="date" class="form-control" id="validationCustomUsername" name="kStartDate"
                                    aria-describedby="inputGroupPrepend" required value="{{ $kioskApplication->kStartDate }}" disabled />
                        ...
                        <div class="col-8 mt-4">
                            <div class="form-outline" data-mdb-input-init>
                                <input type="text" class="form-control" id="matricID" name="kDurationOfRenting" value="{{ $kioskApplication->kDurationOfRenting }}" disabled  />
                        ...
                        <div class="col-8 mt-4">
                            <div class="form-outline" data-mdb-input-init>
                                <input type="text" class="form-control" id="bankAccNumber" name="kBankAccNumber"
                                    aria-describedby="inputGroupPrepend" required value="{{ $kioskApplication->kBankAccNumber }}" disabled  />
                        ...
                        <div class="col-8 mt-4">
                            <div class="form-outline" data-mdb-input-init>
                                <input type="text" class="form-control" id="kBankName" name="kBankName" value="{{ $kioskApplication->kBankName }}" disabled  />
                        ...
                        <form action="{{route('applicationApprovalForPupuk', ['id' => $kioskApplication->kApplicationID])}}" method="POST" class="row g-3 needs-validation"  id="signUpForm" novalidate>
                            @csrf
                            <div class="col-2">
