...
<body>
  ...
  <div class="sidebar">
    <div class="logo-details mt-2">
      <a href="{{route('AdminViewSales')}}"><img src="{{ url('assets/fkkmsLogo.png') }}" alt="Logo" style="width: 180px;" loading="lazy" id="imglogo"/></a>
    ...
    <div class="menu-section">
      ...
      <ul class="nav-list">
        ...
        <li>
          <a href="{{route('AdminViewSales')}}" class="active">
    ...
    <div class="profile-section">
      ...
      <ul class="nav-list">
        ...
        <li style="margin-top: 10px;">
          <a href="{{route('logout', ['userType' => 'admin'])}}">
