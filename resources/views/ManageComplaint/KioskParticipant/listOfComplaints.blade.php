...
<div class="card">
        <div class="card-body">
            <a type="button" class="btn btn-success btn-animation waves-effect waves-light" data-text="New Application" href='{{ url("/kiosk/newApplication")}}'><span>New Application</span></a>
            <br>
            <br>
                ...
                <tbody>
                    ...
                    @foreach ($data as $q)
                        <tr>
                            ...
                            <td >
                                <center>
                                    <a class='btn  btn-animation waves-effect waves-light' href='{{ url("/viewComplaint", ["id" => $q->id]) }}'>
                                        <!-- <i class="ri-eye-line" style="color: green; font-size:20px;"></i> -->
                                        <i class="far fa-eye"></i>
                                    </a>
                                    @if ($q->status=='Pending')
                                        <a type='button' class='btn  btn-animation waves-effect waves-light' href='{{ url("/kiosk/updateComplaints", ["id" => $q->id]) }}'>
